#
#  Be sure to run `pod spec lint IMGPickerManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "tony" => "tonytongfangyuan@gmail.com" }
  # s.social_media_url   = "http://twitter.com/童方园"
  ...
  s.source       = { :git => "https://github.com/TongFangyuan/IMGPickerManager.git", :tag => "0.1.1" }
