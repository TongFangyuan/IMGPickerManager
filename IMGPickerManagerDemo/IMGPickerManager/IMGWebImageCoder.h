 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const IMGWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull IMGCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL IMGCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
 ...
 */
@protocol IMGWebImageCoder <NSObject>
...
/**
 ...
 @param optionsDict A dictionary containing any decompressing options. Pass {IMGWebImageCoderScaleDownLargeImagesKey: @(YES)} to scale down large images
 ...
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(IMGImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol IMGWebImageProgressiveCoder <IMGWebImageCoder>
